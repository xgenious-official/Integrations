...
@if($method('whatsapp_status') == 'on')
    <div class="whatsapp-integration-wrap">
        <a href="https://wa.me/{{get_static_option('whatsapp_mobile_number')}}?text={{get_static_option('whatsapp_initial_text')}}" target="_blank">
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/{{get_static_option('twakto_widget_id')}}/default';
        s1.charset='UTF-8';
